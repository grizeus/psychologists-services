  ...
  return (
    <div className="max-w-110">
      ...
      <form className="flex flex-col gap-4.5" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          className="bg-sun hover:bg-sunset text-snow focus:bg-sunset rounded-3xlg flex items-center justify-center gap-4.5 px-12.5 py-4.5 text-xl leading-6 font-medium transition-colors duration-300 ease-in-out focus:outline-none">
          Log In
        </button>
      </form>
    </div>
